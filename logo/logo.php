...
<style>
    ...
    .mask{
    	clip-path: url(#text-mask);
    		-ms-clip-path:  url(#text-mask);
    	 -webkit-clip-path: url(#text-mask);
    }
...
/*SVG files are included separately so they can be commented out , reordered easily and use variations*/
			...
			include "sgf-globe-01.svg"; //Default Northern Hemisphere
			include "sgf-outer-gradient-aqua-01.svg"; // outer ring
			include "sgf-inner-gradient-aqua-01.svg"; // inner ring
			include "sgf-ring-white-01.svg"; // white background
			//include "sgf-logo-shadow-01.svg"; // logo text shadow
			
if(@ICL_LANGUAGE_CODE){//WPML DISABLED

	if(ICL_LANGUAGE_CODE == 'en'){
		include "sgf-logo-shadow-01.svg"; // logo text shadow
		include "sgf-text-gradient-aqua-01.svg";
		include "sgf-text-mask.php";// mask layer of
	} else if(ICL_LANGUAGE_CODE == 'es'){
		include "sgf-logo-text-es-01.svg";
	}
	...
	include "sgf-text-mask.php";// mask layer of
			...
			//include "sgf-text-gradient-aqua-01.svg"; // SGF layer of text
			 // SGF layer of text

			//include "sgf-text-mask.php";// mask layer of
			
			//include "sgf-text-mask-video.php";// doesn't work yet.
